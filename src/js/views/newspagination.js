...
class NewsPaginationView {
  ...
  _generateMarkup() {
    ...
    if (+curPage === 1 && numPages > 1) {
      return /*html */`
        <li class="page__item shown-md active">
          <a class="page__link" href="#${pre}page=${+curPage}">${+curPage}</a>
        </li>
        <li class="page__item shown-md">
          <a class="page__link" href="#${pre}page=${+curPage + 1}">${+curPage + 1}</a>
        </li>
        <li class="page__item shown-md">
          <a class="page__link" href="#${pre}page=${+curPage + 2}">${+curPage + 2}</a>
        </li>
        <li class="page__item shown-md disabled">
          <a class="page__link">...</a>
        </li>
        <li class="page__item shown-md">
          <a class="page__link page__link--next" href="#${pre}page=${+curPage + 1}">
        ...
        <li class="page__item hidden-md page__item-mobile">
          <a class="page__link page__link--lazy-loading" href="#${pre}page=${+curPage + 1}">
            Xem thêm
            <svg class="page__icon">
    ...
    if (+curPage === 2 && numPages > 1) {
      return /*html */`
        <li class="page__item shown-md">
          <a class="page__link page__link--previous" href="#${pre}page=${+curPage - 1}">
            <svg class="page__icon">
    ...
    if (+curPage === numPages - 1 && numPages > 1) {
      return /*html */`
        ...
        <li class="page__item hidden-md page__item-mobile">
          <a class="page__link page__link--lazy-loading" href="#${pre}page=${+curPage}">
            Trang cuối
            <svg class="page__icon">
              <use href="${icons}#icon-arrow-next"></use>
            </svg>
...
export default new NewsPaginationView();
